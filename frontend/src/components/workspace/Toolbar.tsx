    ...
    <header className="h-[48px] w-full bg-[var(--surface-panel)] border-b border-[var(--border-subtle)] px-4 flex items-center justify-between shrink-0 select-none">
      ...
      <div className="relative flex items-center">
        <select
          ...
          className="appearance-none bg-transparent hover:bg-[var(--surface-card-hover)] text-[var(--text-primary)] text-[13px] font-medium pl-3 pr-8 py-1.5 rounded-lg border border-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--border-focus)] transition-colors cursor-pointer"
        >
